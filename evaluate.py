...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_location', type=str, help='Model which to evaluate performance.')
    parser.add_argument('--reference_file', type=str, help='a text file of reference smiles strings.')
    parser.add_argument('--binary', action='store_true', help='Binary labels on correct string')
    parser.add_argyment('--beam_size', type=int, default=10, help='Beam size of predictions')
