...
def main(args):
    ...
    with open(args.output_file, 'w') as w:
        ...
        w.write("There are {} examples being evaluated\n".format(len(reference_img2smi)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--reference_file', type=str, default='data/evaluation_labels.smi', help='reference img2smi file which is a tsv with SMI\tIMG.PNG')
    parser.add_argument('--candidate_file', type=str, default='outputs/pyosra-predictions.txt', help='candidate img2smi file which is a tsv with SMI\tIMG.PNG')
    parser.add_argument('--output_file', type=str, default ='outputs/pyosra-results.txt', help='Filename where eval results will be written')
