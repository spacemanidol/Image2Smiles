...
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_100.json --output_prefix vocab100 --data_dir /semihot/img2smidata/validation_images/ --data_split validation --image_output_filename validation --output_path data/
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_200.json --output_prefix vocab200 --data_dir /semihot/img2smidata/validation_images/ --data_split validation --image_output_filename validation --output_path data/
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_500.json --output_prefix vocab500 --data_dir /semihot/img2smidata/validation_images/ --data_split validation --image_output_filename validation --output_path data/
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_2000.json --output_prefix vocab2000 --data_dir /semihot/img2smidata/validation_images/ --data_split validation --image_output_filename validation --output_path data/
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_20000.json --output_prefix vocab20000 --data_dir /semihot/img2smidata/validation_images/ --data_split validation --image_output_filename validation --output_path data/ --process_img
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_100.json --output_prefix vocab100 --data_dir /semihot/img2smidata/evaluation_images/ --data_split evaluation --image_output_filename evaluation --output_path data/
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_200.json --output_prefix vocab200 --data_dir /semihot/img2smidata/evaluation_images/ --data_split evaluation --image_output_filename evaluation --output_path data/
python preprocess_data.py --tokenizer tokenizers/tokenizer_vocab_500.json --output_prefix vocab500 --data_dir /semihot/img2smidata/evaluation_images/ --data_split evaluation --image_output_filename evaluation --output_path data/
