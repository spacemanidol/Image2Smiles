...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Preprocess downloaded data for model training.')
    parser.add_argument('--tokenizer', type=str, default='data/validation.smi', help='source of input smiles data')
